...
import DrizzleAbilitiesRepository from '../infrastructure/repositories/DrizzleAbilitiesRepository';
...
container.bind<AbilitiesRepository>(types.AbilitiesRepository).to(DrizzleAbilitiesRepository);
