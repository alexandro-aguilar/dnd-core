...
import PostgresSubracesRepository from '../infrastructure/repositories/PostgresSubracesRepository';
...
container.bind<SubracesRepository>(types.SubracesRepository).to(PostgresSubracesRepository);
