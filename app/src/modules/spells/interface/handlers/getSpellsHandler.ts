...
import { inputGetSpellSchema } from './inputGetSpellSchema';
import GetSpellsController from '../controllers/GetSpellsController';
...
export const handler = middy(
  ...
  .use(requestValidator(inputGetSpellSchema))
