...
import PostgresSpellsRepository from '../infrastructure/repositories/PostgresSpellsRepository';
...
container.bind<SpellsRepository>(types.SpellsRepository).to(PostgresSpellsRepository);
