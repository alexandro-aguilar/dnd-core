...
import DrizzleItemsRepository from '../infrastructure/repositories/DrizzleItemsRepository';
...
container.bind<ItemsRepository>(types.ItemsRepository).to(DrizzleItemsRepository);
